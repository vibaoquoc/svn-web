...
them, has changed.  See L<UPDATING> for more information.
...
If you only have one repository configured then the C<list> action will
immediately redirect to browsing that repository, saving the user from
having to click through an intermediate page.
